                          ...
                          <tbody>
                            <tr>
                              <td align="left" width="40%">
                                <img src="<?= base_url('assets/img/mbkm_umc_color.png') ?>" style="width: 70%; margin: 0 auto; display: block; margin-top: 10px;">
                              </td>
                              <td>
                                <h3>Merdeka Belajar : Kampus Merdeka</h3>
                                  Universitas Muhammdiyah Cirebon <br>
                                  " Islami, Profesional & Mandiri "
                                  <!--Jl. Tuparev No.70, Kedungjaya, Kec. Kedawung, Kabupaten Cirebon, Jawa Barat 45153 <br>-->
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">&copy; Universitas Muhammdiyah Cirebon 2023. All Right Reserved.</span>
                    <br> Developed by <a href="https://github.com/rollerhafeezh">PT Ensitec Global Solution</a>.
                  </td>
                </tr>
              </table>
            </div>
