    ...
    <div class="content__wrap">
        <div class="card text-center mb-4 col-md-6 offset-md-3">
            <div class="card-body">
                ...
                <p class="mb-5">
                	<?= $title ?> hanya muncul apabila sudah di-input oleh akademik.
                </p>
            </div>
        </div>
...
<div class="content__header content__boxed overlapping">
    <div class="content__wrap">
        ...
        <p class="lead">Kelola revisi hasil seminar atau sidang bersama dosen penguji.</p>
    </div>
</div>
			...
			<div class="col-md-12">
				...
				<script>
					...
					const options = {
					    ...
					    userInfo: {
					        displayName: '<?= format_nama($anggota->nm_pd) ?> (PENYAJI)'
					    }
					};
    	...
    	<div class="row">
    		...
    		<div class="col-md">
		        <section class="card mb-3">
		            <div class="card-body">
	            		<div class="float-end <?= $cek_penjadwalan ? 'd-none' : '' ?>">
	            			<?php if (isset($_GET['meet'])): ?>
	            				<a href="<?= base_url('bimbingan/dosen_penguji') ?>" class="btn btn-primary btn-xs position-relative">Stop Meet</a>
	            			<?php else: ?>
	            				<a href="<?= base_url('bimbingan/dosen_penguji?meet') ?>" class="btn btn-info btn-xs position-relative mx-1">Meet Online</a>
	            			<?php endif; ?>
	            		</div>
