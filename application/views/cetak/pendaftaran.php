<html>
	...
	<body>
		...
		<table width="100%">
			<tr>
				<td><center><h3>FORMULIR PENDAFTARAN <?= strtoupper($aktivitas->nama_jenis_aktivitas_mahasiswa) ?></h3></center></td>
			</tr>
		</table>
		<br>
		...
		<p>
			Catatan : <br>
			<i>Cetak berkas pendaftaran ini dan upload bersama proposal sebagai lampiran.</i>
		</p>
	</body>
</html>